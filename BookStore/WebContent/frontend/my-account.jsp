									...
									<div class="panel-body">
										<div class="coupon-info">
											...
											<form action="" method="post">
												...
												<p class="form-row">
													<input type="text" name="current-pass"
												...
												<a title="Save" class="btn button button-small"
													href="index.jsp"> <span> Cập nhật <i
									...
									<div class="panel-body">
										<div class="coupon-info">
											...
											<div class="order-history">
												...
												<table id="dataTable"
													...
													<tbody>
														...
														<tr role="row" class="odd">
															...
															<td class="sorting_1">listSach.get(j).getTenSach()</td>
															<td>listSach.get(j).getSoLuongMua()%></td>
															<td>listSach.get(j).getGia()%>.000đ</td>
														</tr>
												...
												<p>Tổng: listBill.get(i).total()%>.000đ</p>
					...
					<div class="col-xs-12 col-sm-6 col-lg-6">
						<div class="myaccount-link-list">
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a href="cart.jsp"> <i class="flaticon-shop"></i> <span>Giỏ
												hàng của tôi</span>
										</a>
									</h4>
								</div>
				...
				<div class="col-md-12">
					<div class="create-account-button pull-left">
						<a href="index.jsp" class="btn button button-small" title="Home">
							<span> <i class="fa fa-chevron-left"></i> Trở về
						</span>
						</a>
					</div>
				</div>
