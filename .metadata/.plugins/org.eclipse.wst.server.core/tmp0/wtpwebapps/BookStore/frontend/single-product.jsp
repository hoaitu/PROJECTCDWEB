						...
						<div class="tab-content">
							...
							<div role="tabpanel" class="tab-pane active" id="one"
								...
								<a class="venobox" href="img/single-product/bg-1.jpg"
									data-gall="gallery" title=""> <img src="img/shop/tt12.jpg"
									alt="" />
								</a>
				...
				<div class="related-product indicator-style">
					...
					<div class="col-md-3">
						<div class="single-banner">
							...
							<div class="banner-bottom text-center">
								<div class="banner-bottom-title" style="height: 40px">
									<a href="singleProductController?idProduct="> </a>
								</div>
								<div style="color: #32b5f3" class="price-2">
					...
					<div class="col-md-3">
						<div class="single-banner">
							...
							<div class="banner-bottom text-center">
								<div class="banner-bottom-title" style="height: 40px">
									<a href="singleProductController?idProduct=">listSach.get(i).getTenSach()
									</a>
								</div>
								<div style="color: #32b5f3" class="price-2">
									listSach.get(i).getGia()%>.000<span>đ</span>
