 ...
 * Generated at: 2020-10-02 18:51:08 UTC
...
public final class shop_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t\t\t\t<li><a title=\"Quay lại trang chủ\" href=\"index.jsp\">Trang\r\n");
      out.write("\t\t\t\t\t\t\t\t\tchủ </a></li>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"index.jsp\"> <i\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tclass=\"fa fa-angle-double-right\"></i> Khuyến mãi\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</a></li>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"#\"> <i class=\"fa fa-angle-double-right\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tTruyện dài\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"#\"> <i class=\"fa fa-angle-double-right\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tTruyện ngắn\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"#\"> <i class=\"fa fa-angle-double-right\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tTiểu thuyết\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li><a href=\"#\"> <i class=\"fa fa-angle-double-right\"></i>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tTruyện thiếu nhi\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</a></li>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t</aside>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<form name=\"SearchArea\" class=\"form-inline\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input onkeyup=\"search()\" class=\"form-control mr-sm-2\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"text\" name=\"searchBox\" placeholder=\"Search\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</a> <a href=\"#\" title=\"Thêm vào danh sách yêu thích\"> <i\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"banner-bottom text-center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"banner-bottom-title\" style=\"height: 40px\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"\">listSach.get(i).getTenSach()%> </a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div style=\"color: #32b5f3\" class=\"price-2\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"single-product.html\" title=\"Book Name\"> <img\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tsrc=\"");
      out.print(request.getContextPath());
      out.write("/assets/img/shop/tt12.jpg\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\talt=\"\" />\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<h4>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"single-product.jsp\" title=\"Book Name\">Book\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tName </a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</h4>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"product-price\">\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"new-price\">250.000đ</span> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"old-price\">500.000đ</span> <span class=\"new-price\">listSach.get(i).getGia()%>.000đ</span>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"col-xs-12 col-sm-5 col-md-4\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<div class=\"left-item\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"single-product.jsp\" title=\"Book Name\"> <img\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tsrc=\"");
      out.print(request.getContextPath());
      out.write("/assets/img/shop/tt12.jpg\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\talt=\"\" />\r\n");
